...
class EntryAbstract(models.Model):
    ...
    tags = ClusterTaggableManager(through='bila.TagEntryPage', blank=True)
    ...
    categories = models.ManyToManyField('bila.Category', through='bila.CategoryEntryPage', blank=True)
